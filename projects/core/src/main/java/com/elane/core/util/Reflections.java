...
public class Reflections {
     ...
     * @param froms
     */
    public static void copyProperties(Object tos,Object froms) {
        ...
        try {
            Class c1 = froms.getClass();
            Class c2 = tos.getClass();
            ...
            if (null != fields && fields.size() > 0) {
                for (int i = 0; i < fields.size(); i++) {
                    ...
                    try {
                        ...
                        // 特殊情况属性名第一个字母小写
                        str = fileName.substring(0, 1).toLowerCase();
                        // 拼凑getXXX和setXXX方法名
                        getName = "get" + str + fileName.substring(1);
                        setName = "set" + str + fileName.substring(1);
                        try {
                            ...
                            logger.error("The corresponding set get method was not found");
                            continue;
                        }
                    }
                    
                    // 获取属性值
                    Object o = getMethod.invoke(froms, new Object[] {});
                    // 将属性值放入另一个对象中对应的属性
                    if (null != o) {
                        setMethod.invoke(tos, new Object[] { o });
                    }
                }
            }

<%@ page language="java" contentType="text/html;charset=utf-8" pageEncoding="utf-8"%>
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-offset-2 demo">
            <h4>singleDatePicker_test</h4>
            <input type="text" id="singleDatePicker_test" class="form-control">
            <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
          </div>
        </div>
      </div>
      ...
      $(document).ready(function() {
        ...
        $('#singleDatePicker_test').daterangepicker({singleDatePicker:true,format:"YYYY-MM-DD"});
      });
      </script>
